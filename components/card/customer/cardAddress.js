        ...
        {myAddress.isLoading ? (
          ...
          myAddress.data.map((items, index) => (
            ...
            >
              ...
              <button type="button" onClick={e => clickDetail(e, items.id)} className="m-2 font-bold text-primary">
                Change address
              </button>
              <button type="button" className="m-2 font-bold text-gray">
                Delete address
              </button>
            </div>
          ))
                  ...
                  <div className="w-[900px] flex flex-col relative p-6">
                    ...
                    <div className="flex w-full mb-2">
                      ...
                      <div className="flex flex-col w-1/2 ml-4">
                        ...
                        <input
                          onChange={e => setForm({ ...form, recipientPhone: e.target.value })}
                          defaultValue={form.recipientPhone}
                          type="text"
                          className="px-3 mt-2 border rounded h-11"
                        />
                      </div>
